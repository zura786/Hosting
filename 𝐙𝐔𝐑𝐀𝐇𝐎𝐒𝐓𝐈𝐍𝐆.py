...
# --- Configuration ---
TOKEN = '8841956786:AAH3cDT2lK3zPaqOHfUDSykG1Q4aryaURJQ' #bot token dalo yeha
OWNER_ID = 7490595287 #yha tumhra chat id dalo
ADMIN_ID = 7490595287 #yeha koi admin ya tumhara chat id dalo
YOUR_USERNAME = '@Chaiwalazura' #yeha tumhra username dala
UPDATE_CHANNEL = 'https://t.me/+ga77JxU2qPs4N2Zl' #yeha chnl link dalo''
FORCE_JOIN_CHANNELS = {
    "@neverlostheart": "💎 𝐎ғғɪᴄɪᴀʟ 𝐂ʜᴀɴɴᴇʟ",
    "@Zuraplaylistt": "🚀 𝐏ʟᴀʏʟɪsᴛ 𝐂ʜᴀɴɴᴇʟ",
    "@zuragramx": "📜 𝐋ᴇᴀᴋ 𝐒ᴄʀɪᴘᴛs",
    "@zuragramxz": "🔥 𝐏ғᴘ 𝐂ʜᴀɴɴᴇʟ:",
...
COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ["𝐔ᴘᴅᴀᴛᴇᴅ 𝐂ʜᴀɴɴᴇʟ 🎀"],
    ["𝐔ᴘʟᴏᴀᴅ 𝐅ɪʟᴇ 🎀", "𝐂ʜᴇᴄᴋ 𝐅ɪʟᴇs 🎀"],
    ["𝐁ᴏᴛ 𝐒ᴘᴇᴇᴅ 💀", "𝐒ᴛᴀᴛɪsᴛɪᴄs 🧊"],
    ["𝐒ᴇɴᴅ 𝐂ᴏᴍᴍᴀɴᴅ 🎀", "𝐂ᴏɴᴛᴀᴄᴛ 𝐎ᴡɴᴇʀ 🐼"]  # Added Send Command
]
